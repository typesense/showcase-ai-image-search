    ...
    <>
      ...
      >
        <div className='relative'>
          ...
          <input
            className='h-[5vmax] max-h-12 min-h-10 w-[max(50vw,350px)] max-w-[95vw] rounded-xl border-2 border-dark-500 bg-dark-500 py-2 pl-10 pr-4 text-sm shadow-2xl shadow-[black] placeholder:text-white-400 placeholder:opacity-50 focus:border-accent focus:border-opacity-40 focus:outline-none'
            type='text'
